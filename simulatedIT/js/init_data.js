...
$(document).ready(function(){
  ...
  window.plot = Bokeh.Plotting.figure({
		title: "",
		x_range: new Bokeh.Range1d({ start: 5250, end: 6500 }),
		y_range: new Bokeh.Range1d({ start: 70000, end: 700000 }),
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        var simulatedITList = [];
        for (var i = 0; i < energy.length; i++) {
            simulatedITList.push( i0[i] * Math.pow(Math.E, - mu_t_input[i] ) );
        }

	newSource2 = new Bokeh.ColumnDataSource({
	    data: { x: energy, y: simulatedITList }
	});
